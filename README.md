...
Este error indica que numpy no está disponible en el entorno de ejecución. Asegúrate de que numpy esté instalado:
```bash
pip install numpy
```

### Error de Configuración
Si ves errores de configuración al iniciar:
...
1. Verifica que el puerto 8501 esté disponible
2. Revisa la configuración de firewall
...
**OkuoAgent** - Tu asistente inteligente para análisis de datos 🤖
